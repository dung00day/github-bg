...
class MyApplication(QMainWindow):
    def __init__(self):
        ...
        self.machine4 = ReadSerial(self.config[4], int(self.config[3]))
    ...
    def receiveSignalSfc(self):
        ...
        while True:
            ...
            elif (signal_sfc == sfc_weighted) & (not self.flag_weighted):
            ...
            if self.flag_weighted:
                if signal_sfc == sfc_OK:
                    ...
                    logger.warning(f'result from sfc: {sfc_NG}')
                    self.flag_weighted = False
                    break
                ...
                logger.error(f'error scan 2: {sfc_NG}')
                self.flag_weighted = False
                break
    ...
    def receiveSignalMachine1(self):
        ...
        while True:
            ...
            if signal_machine1 == plc_scan:
                ...
                self.machine4.send_data(cuong_scan)
    ...
    def waitResultMachine4(self):
        while True:
            ...
            if signal_machine4 == cuong_ok:
                self.machine1.send_data(sfc_OK)
                break
            elif signal_machine4 == cuong_ng:
                self.machine1.send_data(sfc_NG)
                break
