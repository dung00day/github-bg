...
class MyApplication(QMainWindow):
    def __init__(self):
        ...
        self.serial_sfc_send = ReadSerial("COM9", 9600)
        self.serial_sfc_receive = ReadSerial("COM11", 9600)
        self.machine1 = ReadSerial("COM13", 9600)
        self.machine4 = ReadSerial("COM15", 9600)
