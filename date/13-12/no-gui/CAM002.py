...
class MyApplication():
    ...
    def receiveSignalSfc(self):
        ...
        while True:
            ...
            elif (signal_sfc == sfc_OK) and self.flag_weighted:
    ...
    def runThread(self):
        ...
        threadSfc = threading.Thread(target=self.signalSfc)
        threadMachine1 = threading.Thread(target=self.signalMachine1)
        threadCam.start()
        threadSfc.start()
