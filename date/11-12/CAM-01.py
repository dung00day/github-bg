...
class MyApplication(QMainWindow):
    ...
    def receiveSignalSfc(self):
        ...
        while True:
            ...
            if self.flag_reset:
            ...
            elif (data_sfc == sfc_weighted) | (data_sfc == sfc_weighted_demo):
                ...
                while True:
                    ...
                    if (data_weight2 == sfc_weighted) | (data_weight2 == sfc_weighted_demo):
            ...
            if self.flag_weighted & self.flag_cam_scan:
                ...
                if ex_signal == 1:
                    ...
                    print('máy 1 gửi kết quả sfc fail tới s4-190')
    ...
    def receivePlc(self):
        ...
        while True:
            ...
            if ((signal_plc == plc_scan_receive) | (signal_plc == plc_test_scan)) & self.flag_weighted:
