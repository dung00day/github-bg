    ...
    def receiveSignalSfc(self):
        ...
        while True:
            ...
            if self.flag_reset:
                ...
                while True:
                    ...
                    if data_weight2 == sfc_weighted:
                        ...
                        break
            # Cần chờ kết quả từ s4-190 thì mới nhận tín hiệu từ sfc
            if self.result_s4_190 == s4_190_OK:
                ...
                self.result_item1 = sfc_NG
        # Chờ kết quả máy 2
        print('máy 1: chờ kết quả máy 2...')
        self.waitResultMachine2()
        # Xử lý kết quả, gửi cho plc
        print('Xử lý kết quả để gửi cho plc')
        self.calcResult(self.result_item1, self.result_machine2)
        ...
        while True:
            ...
            if (signal_plc == plc_scan_receive) | (signal_plc == plc_test_scan):
                ...
                # quét qr thành công
                    ...
                    self.changeStatus(status_pass)
                    print('máy 1 scan xong, gửi QR code cho s4-190...')
